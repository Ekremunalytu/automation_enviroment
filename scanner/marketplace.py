...
VS Code Marketplace HTTP Client & VSIX Extraction
--------------------------------------------------

Provides two functions for interacting with the VS Code Marketplace:
    - search_marketplace: Query the Marketplace gallery API
    - download_and_extract_vsix: Download a VSIX and extract it to disk

No database access. Pure HTTP + filesystem operations.
"""
