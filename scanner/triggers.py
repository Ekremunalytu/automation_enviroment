...
Host-side trigger selection for smart activation coverage.

Reads an extension's activationEvents from the database, selects the
relevant automation scenarios, and writes a trigger payload JSON file
to the shared /results volume so the container-side entrypoint can
load it.
"""
