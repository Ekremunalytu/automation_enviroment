...
function SelectedEventHero({ inspector }: { inspector: EvidenceInspectorView }) {
  return (
...
function ProvenanceTab({ inspector }: { inspector: EvidenceInspectorView }) {
  return (
...
function RelationsTab({ inspector }: { inspector: EvidenceInspectorView }) {
...
function RulesTab({ ruleDraft }: { ruleDraft: RuleDraftView | null }) {
  if (!ruleDraft) {
    return (
...
function buildRelationSummary(inspector: EvidenceInspectorView) {
  return buildRelationClusters(inspector).flatMap((cluster) =>
