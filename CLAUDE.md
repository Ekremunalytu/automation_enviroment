...
- W8-W13 planning is owned by `documents/REFACTOR_OPTIMIZATION.md` section 11;
  ...
  **217 passed** (Makefile target list; W16-7-followup
  `test_unaccounted_dropout_surface.py` +3 not yet enrolled —
  flagged for W18 makefile-target hygiene); full suite **1899
