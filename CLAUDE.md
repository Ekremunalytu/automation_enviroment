...
- W8-W13 planning is owned by `documents/REFACTOR_OPTIMIZATION.md` section 11;
  ...
  **Previous phase: W19 — Live-Run Kök Neden: Dropout + Harness
  ...
  `cd82153`); W19-6-followup-2 pre-merge hygiene (this commit) —
