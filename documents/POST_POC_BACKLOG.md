...
`Last Updated: 2026-05-11 (slimmed after W13-4; H3/M1/M9 remain W13 acceptance-bar open; doc drift fixes closed I1 + three cleanup docstring items)`
...
|---|---|---|
| `[FOLLOWUP codex-2026-05-10-H3-dev-lan-makefile-drift]` | open; W13-5 pull-eligible | `make dev-lan` still hard-codes wildcard host; docs now clarify host-mode semantics, but recipe/gate decision remains |
