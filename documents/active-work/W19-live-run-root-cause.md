...
- **W19 closed synthetically `2026-05-26` — on `week19` branch per
  user direction (2026-05-21; W11-W18 paterni preserved); merged to
  main via PR #28 `c879603` on `2026-05-26`.** Sub-iter commits landed
  on `week19`; close-out merged into `main` via PR #28 `week19 -> main`.
