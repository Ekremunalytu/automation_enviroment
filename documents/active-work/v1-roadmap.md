...
`Active named stream: static-analysis-artifact-precision (SAP-0..SAP-6), limited to offline/static analysis; the SMF foundation plus SAP-0..SAP-4 baseline merged via PR #40, while SAP-5 and SAP-6 are branch-published, implementation complete, and unmerged. Latest fully closed named stream: verdict-provenance-reproducibility (W26), PR #38 bfb2d2d. Containment safety remains the next product/release gate.`
