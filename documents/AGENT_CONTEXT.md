...
- W8-W18 are closed; W13 merged via PR #20 (`772deb3`); W14 merged via
  ...
  W11-W18 paterni preserved). W19-0 doc-reconcile landed this
  commit (`week19` branch open + 8-doc canonical preamble refresh
  + new W19 active-work tracker + §17 W19 plan header doc-open +
  §17-§20 split into §17 W19 active + §18-§20 W20-W22 planning +
  README phase-pointer arch gate transition W18→W19 + baseline
  live-run smoke). Sub-iter slate W19-0..W19-6 reserved by §17
  plan; stable IDs W19-1..W19-5 reserved at `POST_POC_BACKLOG.md`
  W19 Pull-Forward Acceptance Bar. **W19 scope**: Hat-1 executor
  muhasebe bug (W19-1 RED fixture + W19-2 emit-site fix) + Hat-2
  harness verification gap (W19-3 schema landing + W19-4
  onDebug* + W19-5 onTerminal/onLM). Hat-3 coverage matrix
  promotion deferred to W20-W22. **Previous phase:** W18 —
