...
`Active named stream: static-analysis-artifact-precision (SAP-0..SAP-6), stacked on the unmerged SMF head. Latest merged named stream: verdict-provenance-reproducibility (W26), PR #38 at bfb2d2d. Containment safety remains the next product/release gate in active-work/v1-roadmap.md §4.`
