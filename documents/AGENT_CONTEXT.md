...
- W8-W13 plan: `REFACTOR_OPTIMIZATION.md` section 11; W14 plan:
  ...
  `REFACTOR_OPTIMIZATION.md` section 15; **W18-W22 multi-iter roadmap:
  `REFACTOR_OPTIMIZATION.md` sections 16-20** (W18 active as of
...
- W8-W17 are closed; W13 merged via PR #20 (`772deb3`); W14 merged via
  ...
  **W17 merged via PR #25 (`bff565d`) on `2026-05-18`**.
  Past W8/W11/W12/W13/W14/W15/W16/W17 trackers remain only for stable
  IDs referenced by code/tests. **Active phase:** W18 — Heartbeat
  Refactor (**W18-0 doc-reconcile in progress 2026-05-21** on the
  `week18` branch per user direction (W11-W17 paterni preserved
  2026-05-21); sub-iter slate W18-0..W18-4 reserved per §16 plan:
  W18-0 doc-reconcile + W18-1 ADR
  `documents/adrs/0012-heartbeat-thread-relocation.md` + W18-2
  heartbeat refactor implementation + W18-3 lifecycle harness
  extension tests + W18-4 close-out PR `week18 -> main`). Active
  tracker: `active-work/W18-heartbeat-refactor.md`; multi-iter
