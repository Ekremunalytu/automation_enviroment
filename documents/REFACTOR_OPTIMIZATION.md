...
opened at W21-N and merged via PR #30 `week21 -> main` `5dc18aa`.** Active tracker:
...
- **W21-N close-out** — W19-6 / W20-5 paterni: 10-doc canonical
  ...
  live-run + PR #30 `week21 -> main` MERGED `5dc18aa`.
