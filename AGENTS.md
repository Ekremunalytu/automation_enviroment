...
- **W8 closed `2026-04-29`; W9 closed `2026-05-04` via PR #9; W10
  ...
  **Active phase: W19 — Live-Run Kök Neden: Dropout + Harness
  ...
  `documents/active-work/W19-live-run-root-cause.md`. **Sub-iter
  slate W19-0..W19-6 reserved**: W19-0 doc-reconcile (this
  commit — `week19` branch + 8-doc canonical preamble refresh +
  new W19 tracker + §17 W19 plan header doc-open + §17-§20 split
  into §17 W19 active + §18-§20 W20-W22 planning + README
  phase-pointer arch gate transition W18→W19 + baseline live-run
  smoke); W19-1 `[BUG scenario-unaccounted-dropout-regression-fixture]`
  (RED fixture xfail strict); W19-2 `[BUG scenario-unaccounted-dropout-debug-refactor]`
  (emit-site fix); W19-3 `[GOAL harness-verification-contract-event-level]`
  ...
  static W18 final bar (1907/201/220) remains 🟢. Hat-3 coverage
  matrix promotion deferred to W20-W22 per multi-iter roadmap.
